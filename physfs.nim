...
proc setSaneConfig*(organization: cstring; appName: cstring; 
  ...
  #           gleaned from PHYSFS_getLastError().
  # 
proc mkdir*(dirName: cstring): cint
  ...
  #  \sa PHYSFS_delete
  # 
proc delete*(filename: cstring): cint
  #*
  ...
  #           gleaned from PHYSFS_getLastError().
  # 
proc getRealDir*(filename: cstring): cstring
  #*
...
proc exists*(fname: cstring): cint
  ...
  # 
proc isDirectory*(fname: cstring): cint
  #*
  ...
  #  \sa PHYSFS_isSymbolicLink
  # 
proc isSymbolicLink*(fname: cstring): cint
  #*
  ...
  #  \sa PHYSFS_isDirectory
  # 
proc getLastModTime*(filename: cstring): PHYSFS_sint64
  #*
  ...
  # 
proc openWrite*(filename: cstring): ptr PHYSFS_File
  # i/o stuff... 
  #*
  ...
  #  \sa PHYSFS_close
  # 
proc openAppend*(filename: cstring): ptr PHYSFS_File
  #*
...
proc openRead*(filename: cstring): ptr PHYSFS_File
  ...
  #  \sa PHYSFS_close
  # 
proc close*(handle: ptr PHYSFS_File): cint
  #*
  ...
  #  \sa PHYSFS_openAppend
  # 
proc read*(handle: ptr PHYSFS_File; buffer: pointer; 
  ...
  #  \sa PHYSFS_eof
  # 
proc write*(handle: ptr PHYSFS_File; buffer: pointer; 
                   objSize: PHYSFS_uint32; objCount: PHYSFS_uint32): PHYSFS_sint64
  #*
  ...
  # 
proc eof*(handle: ptr PHYSFS_File): cint
  # File position stuff... 
  #*
  ...
  #  \sa PHYSFS_tell
  # 
proc tell*(handle: ptr PHYSFS_File): PHYSFS_sint64
  #*
  ...
  #  \sa PHYSFS_seek
  # 
proc seek*(handle: ptr PHYSFS_File; pos: PHYSFS_uint64): cint
  #*
  ...
  #  \sa PHYSFS_tell
  # 
proc fileLength*(handle: ptr PHYSFS_File): PHYSFS_sint64
  #*
  ...
  #  \sa PHYSFS_seek
  # 
proc setBuffer*(handle: ptr PHYSFS_File; bufsize: PHYSFS_uint64): cint
  # Buffering stuff... 
  #*
  ...
  #  \sa PHYSFS_close
  # 
proc flush*(handle: ptr PHYSFS_File): cint
  #*
  ...
  #  \sa PHYSFS_close
  # 
proc swapSLE16*(val: PHYSFS_sint16): PHYSFS_sint16
  # Byteorder stuff... 
  #*
  ...
  # 
proc swapULE16*(val: PHYSFS_uint16): PHYSFS_uint16
  #*
  ...
  #    \return converted value.
  # 
proc swapSLE32*(val: PHYSFS_sint32): PHYSFS_sint32
  #*
  ...
  #    \return converted value.
  # 
proc swapULE32*(val: PHYSFS_uint32): PHYSFS_uint32
  #*
  ...
  #    \return converted value.
  # 
proc swapSLE64*(val: PHYSFS_sint64): PHYSFS_sint64
  #*
  ...
  # 
proc swapULE64*(val: PHYSFS_uint64): PHYSFS_uint64
  #*
  ...
  #           any sort of 64-bit support.
  # 
proc swapSBE16*(val: PHYSFS_sint16): PHYSFS_sint16
  #*
  ...
  #    \return converted value.
  # 
proc swapUBE16*(val: PHYSFS_uint16): PHYSFS_uint16
  #*
  ...
  #    \return converted value.
  # 
proc swapSBE32*(val: PHYSFS_sint32): PHYSFS_sint32
  #*
  ...
  #    \return converted value.
  # 
proc swapUBE32*(val: PHYSFS_uint32): PHYSFS_uint32
  #*
...
proc swapSBE64*(val: PHYSFS_sint64): PHYSFS_sint64
  #*
  ...
  #           any sort of 64-bit support.
  # 
proc swapUBE64*(val: PHYSFS_uint64): PHYSFS_uint64
  #*
  ...
  #           any sort of 64-bit support.
  # 
proc readSLE16*(file: ptr PHYSFS_File; val: ptr PHYSFS_sint16): cint
  #*
  ...
  # 
proc readULE16*(file: ptr PHYSFS_File; val: ptr PHYSFS_uint16): cint
  #*
  ...
  # 
  # 
proc readSBE16*(file: ptr PHYSFS_File; val: ptr PHYSFS_sint16): cint
  #*
  ...
  #            from PHYSFS_getLastError().
  # 
proc readUBE16*(file: ptr PHYSFS_File; val: ptr PHYSFS_uint16): cint
  #*
  ...
  # 
  # 
proc readSLE32*(file: ptr PHYSFS_File; val: ptr PHYSFS_sint32): cint
  #*
  ...
  #            from PHYSFS_getLastError().
  # 
proc readULE32*(file: ptr PHYSFS_File; val: ptr PHYSFS_uint32): cint
  #*
  ...
  # 
  # 
proc readSBE32*(file: ptr PHYSFS_File; val: ptr PHYSFS_sint32): cint
  #*
  ...
  #            from PHYSFS_getLastError().
  # 
proc readUBE32*(file: ptr PHYSFS_File; val: ptr PHYSFS_uint32): cint
  #*
  ...
  # 
  # 
proc readSLE64*(file: ptr PHYSFS_File; val: ptr PHYSFS_sint64): cint
  #*
  ...
  #           any sort of 64-bit support.
  # 
proc readULE64*(file: ptr PHYSFS_File; val: ptr PHYSFS_uint64): cint
  #*
  ...
  #           any sort of 64-bit support.
  # 
proc readSBE64*(file: ptr PHYSFS_File; val: ptr PHYSFS_sint64): cint
  #*
  ...
  #           any sort of 64-bit support.
  # 
proc readUBE64*(file: ptr PHYSFS_File; val: ptr PHYSFS_uint64): cint
  #*
  ...
  #           any sort of 64-bit support.
  # 
proc writeSLE16*(file: ptr PHYSFS_File; val: PHYSFS_sint16): cint
  #*
  ...
  # 
proc writeULE16*(file: ptr PHYSFS_File; val: PHYSFS_uint16): cint
  #*
  ...
  #            find out what went wrong from PHYSFS_getLastError().
  # 
proc writeSBE16*(file: ptr PHYSFS_File; val: PHYSFS_sint16): cint
  #*
  ...
  #            find out what went wrong from PHYSFS_getLastError().
  # 
proc writeUBE16*(file: ptr PHYSFS_File; val: PHYSFS_uint16): cint
  #*
  ...
  #            find out what went wrong from PHYSFS_getLastError().
  # 
proc writeSLE32*(file: ptr PHYSFS_File; val: PHYSFS_sint32): cint
  #*
  ...
  #            find out what went wrong from PHYSFS_getLastError().
  # 
proc writeULE32*(file: ptr PHYSFS_File; val: PHYSFS_uint32): cint
  #*
  ...
  #            find out what went wrong from PHYSFS_getLastError().
  # 
proc writeSBE32*(file: ptr PHYSFS_File; val: PHYSFS_sint32): cint
  #*
  ...
  #            find out what went wrong from PHYSFS_getLastError().
  # 
proc writeUBE32*(file: ptr PHYSFS_File; val: PHYSFS_uint32): cint
  #*
  ...
  #            find out what went wrong from PHYSFS_getLastError().
  # 
proc writeSLE64*(file: ptr PHYSFS_File; val: PHYSFS_sint64): cint
  #*
  ...
  #           any sort of 64-bit support.
  # 
proc writeULE64*(file: ptr PHYSFS_File; val: PHYSFS_uint64): cint
  #*
  ...
  #           any sort of 64-bit support.
  # 
proc writeSBE64*(file: ptr PHYSFS_File; val: PHYSFS_sint64): cint
  #*
  ...
  #           any sort of 64-bit support.
  # 
proc writeUBE64*(file: ptr PHYSFS_File; val: PHYSFS_uint64): cint
  #*
...
proc isInit*(): cint
  ...
  #  \sa PHYSFS_deinit
  # 
proc symbolicLinksPermitted*(): cint
  #*
...
proc setAllocator*(allocator: ptr PHYSFS_Allocator): cint
  #*
...
proc mount*(newDir: cstring; mountPoint: cstring; appendToPath: cint): cint
  ...
  # 
proc getMountPoint*(dir: cstring): cstring
  #*
...
type 
  PHYSFS_EnumFilesCallback* = proc (data: pointer; origdir: cstring; 
    ...
    # 
proc getCdRomDirsCallback*(c: PHYSFS_StringCallback; d: pointer)
  #*
...
proc utf8ToUcs2*(src: cstring; dst: ptr PHYSFS_uint16; 
  ...
  #    \param len Size, in bytes, of destination buffer.
  # 
proc utf8FromLatin1*(src: cstring; dst: cstring; len: PHYSFS_uint64)
  #*
